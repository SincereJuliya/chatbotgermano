...
def render_text_with_citations(text: str):
    ...
    <div class="hover-text" style = "color: #0F172A; letter-spacing: 0.01em;line-height: 1.6;font-family: sans-serif;font-size: 14px;font-weight: 400;margin: 0 0 16px 0;padding: 0;word-break: break-word;">{text}</div>
    <script>
